...
You will create documentation across the four Diataxis quadrants. You must understand the distinct purpose of each:
...
1. **Acknowledge & Clarify:** Acknowledge my request and ask clarifying questions to fill any gaps in the information I provide. You MUST determine the following before proceeding:
    ...
    - **Target Audience:** (e.g., novice developers, experienced ML engineers, non-technical users)
